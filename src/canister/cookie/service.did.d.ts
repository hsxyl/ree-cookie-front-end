...
export type GameStatus = { 'Ended' : null } |
  { 'Play' : null } |
  { 'Withdrawable' : null } |
  { 'RunesMinted' : null } |
  { 'Initialize' : { 'init_btc' : boolean, 'init_key' : boolean } } |
  { 'LiquidityAdded' : null };
